          ...
          <div class="ultimaCarrera">
            ...
            <div class="centrarIf">
              <div class="contenido-izquierda">
                ...
                <br/>
                <div class="top">
                  <i class='bx bx-signal-1' style="color:#FFFFFF"></i> <!--Cambiar colores por escu-->
                ...
                <div
                  class="top">
                  <i class='bx bx-signal-2' style="color:#FFFFFF"></i>
                  <div class="piloto-tiempo">
                    <p class="polenombre">
                ...
                <div
                  class="top">
                  <i class='bx bx-signal-3' style="color:#FFFFFF"></i>
                  <div class="piloto-tiempo">
                    <p class="polenombre">
